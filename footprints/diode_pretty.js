module.exports = {
    ...
    (module ComboDiode-Pretty (layer F.Cu) (tedit 5B24D78E)
        ...
        ${''/* Traces */}
        (pad 1 smd custom (at -3.0 0 ${p.rot}) (size 0.25 0.25) (layers F.Cu) 
          (zone_connect 0) 
          (options (clearence convexhull) (anchor circle))
          (primitives 
            (gr_line (start 0 0) (end 1.1 0) (width 0.25))
          ) ${p.to})
        (pad 1 smd custom (at -3.0 0 ${p.rot}) (size 0.25 0.25) (layers B.Cu) 
          (zone_connect 0) 
          (options (clearence convexhull) (anchor circle))
          (primitives 
            (gr_line (start 0 0) (end 1.1 0) (width 0.25))
          ) ${p.to})
         (pad 2 smd custom (at 1.9 0 ${p.rot}) (size 0.25 0.25) (layers F.Cu) 
          (zone_connect 0) 
          (options (clearence convexhull) (anchor circle))
          (primitives 
            (gr_line (start 0 0) (end 1.1 0) (width 0.25))
          ) ${p.from})
         (pad 2 smd custom (at 1.9 0 ${p.rot}) (size 0.25 0.25) (layers B.Cu) 
          (zone_connect 0) 
          (options (clearence convexhull) (anchor circle))
          (primitives 
            (gr_line (start 0 0) (end 1.1 0) (width 0.25))
